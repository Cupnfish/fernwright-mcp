...
For compatibility, the binary name and some internal identifiers currently remain `playright-mcp` and `playwright-tab-bridge`.
...
- `PLAYWRIGHT_MCP_HTTP_ADDR` (default: `127.0.0.1:3000`)
...
```toml
[mcp_servers.playwright-tab-bridge]
url = "http://localhost:3000/mcp"
```
